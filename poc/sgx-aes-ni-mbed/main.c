...
int main(int argc, char **argv)
{
	...
	if (argc != 3)
	{
		printf("Need 2 args: %s iterations count \n", program);
		exit(-1);
	}
	// init hw volt
	...
	for(int i=0; i<count; i++) {
		...
		for (int ii =0; ii< 3; ii++) {
			...
			configure_glitch_with_delay(1, 0.835, 29, 0.625 - 0.005*i, -25, 0.835, 1300);
			//configure_glitch_with_delay(1, 0.835, 29, 0.935 - 0.005*i, -25, 0.835, 1300);
